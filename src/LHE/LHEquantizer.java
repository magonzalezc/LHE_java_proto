...
//****************************************************************************				
	 ...
	 * @param result_YUV
	 */
	public void quantizeOneHopPerPixel_adaptativeExperiments(int[] hops,int[] result_YUV)
	{
		System.out.println("quantizying...");
	 ...
	 * @param result_YUV
	 */
	public void quantizeOneHopPerPixel_adaptativeTest(int[] hops,int[] result_YUV)
	{
		System.out.println("quantizying...");
